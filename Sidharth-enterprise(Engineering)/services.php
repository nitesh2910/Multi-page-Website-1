    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 text-center">
                <h2 class="text-uppercase text-white mrb-10">All Services</h2>
                <ul class="mb-0 justify-content-center">
                    <li class="breadcrumb-item"><a href="index.php" class="text-white">Home</a></li>
                    <li class="breadcrumb-item text-primary-color">All Services</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4 col-xl-4">
                    <div class="service-item">
                        ...
                        <p class="mrb-0">Lorem Ipsum is simply dummy text of the printing and typesetting indstry. lpsum
                            has been the</p>
                    ...
                    <div class="owl-carousel testimonial-items-3col owl-dot-style-one">
                        <div class="testimonial-item">
                            <div class="testimonial-content">
                                <p class="mrb-0">Distinctively exploit optimal alignments for intuitive quickly
                                    coordinate business applications throughe Seamlessly for optimal testing procedures
                                    process</p>
                            </div>
                            <div class="testimonial-thumb">
                                <div class="client-img">
                                    <img class="img-fluid" src="images/testimonials/testimonial-img1.jpg"
                                        alt="testimonial-img">
                                </div>
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-thumb">
                                <div class="client-img">
                                    <img class="img-fluid" src="images/testimonials/testimonial-img2.jpg"
                                        alt="testimonial-img">
                                </div>
                                <div class="client-info">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-thumb">
                                <div class="client-img">
                                    <img class="img-fluid" src="images/testimonials/testimonial-img3.jpg"
                                        alt="testimonial-img">
                                </div>
                                <div class="client-info">
                        ...
                        <div class="testimonial-item">
                            ...
                            <div class="testimonial-thumb">
                                <div class="client-img">
                                    <img class="img-fluid" src="images/testimonials/testimonial-img4.jpg"
                                        alt="testimonial-img">
                                </div>
                                <div class="client-info">
                                    <h5 class="name">Seymour Butz</h5>
